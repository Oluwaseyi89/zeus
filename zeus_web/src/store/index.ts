...
// Export hooks for better DX - using useShallow to prevent infinite loops
...
export const useWallet = () => useStore(
  useShallow((state) => ({
    wallets: state.wallets,
    activeWallet: state.activeWallet,
...
export const useOrderBook = () => useStore(
  useShallow((state) => ({
    orders: state.orders,
    isLoading: state.isLoading,
    error: state.error,
