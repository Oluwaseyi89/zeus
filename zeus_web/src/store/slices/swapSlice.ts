...
// We use any out-arguments for composition compatibility in the root store
export const createSwapSlice: StateCreator<any, [], [], SwapSlice> = (set, get) => ({
  // State
  swapOrders: [], // Renamed to swapOrders
  currentOrder: null,
  isLoading: false,
  error: null,
...
// export const createSwapSlice: StateCreator<SwapSlice> = (set, get) => ({
//   // State
//   orders: [],
//   currentOrder: null,
//   isLoading: false,
...
//       set((state) => ({
//         orders: state.orders.map(o => o.id === swapId ? order : o),
//         currentOrder: order,
//         isLoading: false,
//       }));
